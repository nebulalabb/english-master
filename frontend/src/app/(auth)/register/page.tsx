      ...
      <div className="right-panel">
        ...
        <div className="form-container">
          <div className="form-header">
            <h1>
              Tạo tài khoản<br />
              ngay hôm nay! <span>🎉</span>
            </h1>
            <p>Tham gia cùng 50.000+ học viên đang cải thiện tiếng Anh mỗi ngày</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="field">
                <label htmlFor="confirmPassword">
                  Xác nhận MK <span className="req">*</span>
                </label>
                <div className="input-wrap">
                  <IconShield />
                  <input
            ...
            <div className="form-meta !justify-start mb-6">
              <label className="remember" htmlFor="agreeToTerms">
                <input
                  id="agreeToTerms"
                  type="checkbox"
                  checked={agreeToTerms}
                  onChange={(e) => setValue('agreeToTerms', e.target.checked as any)}
                />
                <div className="check-box">
                  <IconCheckmark />
                </div>
                <span className="text-xs">
                  Tôi đồng ý với <Link href="/terms" className="text-brand-orange font-bold hover:underline">Điều khoản dịch vụ</Link> và <Link href="/privacy" className="text-brand-orange font-bold hover:underline">Chính sách bảo mật</Link> của NebulaEnglish
                </span>
              </label>
            </div>
            {errors.agreeToTerms && (
              <p style={{ color: 'var(--primary)', fontSize: '11px', marginTop: '-18px', marginBottom: '16px', fontWeight: 600 }}>
          ...
          <div className="register-row">
            Đã có tài khoản?{' '}
            <Link href="/login" className="font-bold">Đăng nhập ngay ➔</Link>
          </div>
        </div>
      </div>
    </div>
